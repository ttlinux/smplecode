package com.lottery.biying.ThirdParty.Bubble;
    ...
    private void updateBorderArrowPeak(BubbleStyle.ArrowDirection direction, BubbleStyle.ArrowPosPolicy policy, PointF arrowTo, Shape outShape) {
        switch (direction) {
            case Left:
                ...
                outShape.ArrowPeakY = Utils.bound(outShape.Rect.top + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Up:
                outShape.ArrowPeakX = Utils.bound(outShape.Rect.left + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
            ...
            case Right:
                ...
                outShape.ArrowPeakY = Utils.bound(outShape.Rect.top + outShape.TopRightRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Down:
                outShape.ArrowPeakX = Utils.bound(outShape.Rect.left + outShape.BottomLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                        getUpDownArrowPeakX(policy, arrowTo, outShape),
