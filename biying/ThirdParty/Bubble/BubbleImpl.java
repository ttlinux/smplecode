...
class BubbleImpl implements BubbleStyle {
    ...
    void init(View view, Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mArrowHeight = ta.getDimension(R.styleable.BubbleStyle_bb_arrowHeight, Utils.dp2px(6));
            mArrowWidth = ta.getDimension(R.styleable.BubbleStyle_bb_arrowWidth, Utils.dp2px(10));
            ...
            float radius = ta.getDimension(R.styleable.BubbleStyle_bb_cornerRadius, Utils.dp2px(4));
