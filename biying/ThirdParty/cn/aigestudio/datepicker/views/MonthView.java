package com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.views;
...
import com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.bizs.calendars.DPCManager;
import com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.bizs.decors.DPDecor;
import com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.bizs.themes.DPTManager;
import com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.cons.DPMode;
import com.lottery.biying.ThirdParty.cn.aigestudio.datepicker.entities.DPInfo;
            ...
            for (int j = 0; j < tmp[i].length; j++) {
                ...
                if (region.contains(x, y)) {
                    ...
                    if (mDPMode == DPMode.SINGLE) {
                        ...
                        String year=centerYear+"";
                        String month=centerMonth>9?centerMonth+"":("0"+centerMonth);
                        String m_date=mCManager.obtainDPInfo(centerYear, centerMonth)[i][j].strG;
                        m_date=m_date.length()>1?m_date:("0"+m_date);
                        date=year + "-" + month + "-" +
                                m_date;
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                            ...
                            if (null != onDatePickedListener) {
                                onDatePickedListener.onDatePicked(date,year,month,m_date);
                            }
                        }
