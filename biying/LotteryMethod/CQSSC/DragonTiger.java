 ...
 */
public class DragonTiger extends BaseAnalysisClass{


    public static DragonTiger dragonTiger;
    public static DragonTiger getInstance()
    {
        if(dragonTiger==null)
            dragonTiger=new DragonTiger();
        return dragonTiger;
    }
