...
//        textView2.setTextColor(0xFFEE1F3B);
    ...
    //加---的 时时彩才要
    public static String pl5_result(int playtype,String value)
    {
        return value;
    }

    //排列组合的用html做颜色
    public static void pl5_result_style(int playtype,String value,TextView textView)
    {
        textView.setText(Html.fromHtml(value));
    }

    public static int pl5(ArrayList<ArrayList<LotteryButton>> arrayLists, double price, int playtype,
    ...
    public static int pl5_order(ArrayList<ArrayList<LotteryButton>> arrayLists, int playtype) {
    ...
    //确认订单的随机
    public static OrderConfirmAdapter.Itemvalue pl5_comfirm(int typeindex,String lotteryname)
    {
        ...
        value.setTimes(1);
        value.setLotterytype(LotteryTypeName.PL5);
        value.setPlaytype(typeindex);
        value.setItemvalueV1(PL5_Method.pl5_result(typeindex, sb.toString()));
        return value;
    }

    public static double[] pl5_CalculateMoney(double money, CalculateBet bean) {
    ...
    public static void pl5_Random(int index,ArrayList<ArrayList<LotteryButton>> buttonnumbers,HashMap<String, LotteryButton> Selectednumbers)
    {
        int radomnumber[];
        Random random = new Random();
    ...
    public static String pl5_calculateReword(int bettype,int zhu,CalculateBet cbet, int...winmoney)
    {
        StringBuilder sb=new StringBuilder();
...
//        sb.append("奖金"+winmoney[0]+"元,");
    ...
    public static boolean pl5_Btn(int playtype, IndexRecordBean bean, ArrayList<ArrayList<LotteryButton>> arrayLists) {
